...
class Pagination(object):
    ...
    def html(self):
        ...
        for i in range(start_page, end_page + 1):
            ...
            if i == self.page:
                ele = '<li class="page-item active" aria-current="page"><a class="page-link" href="?{}">{}</a></li>'.format(self.query_dict.urlencode(), i)
            else:
        ...
        search_string = """
            <li>
                <form style="float: left;margin-left: -1px" method="get">
                    ...
                    <button style="border-radius: 0" class="btn btn-outline-primary" type="submit">跳转</button>
                </form>
            </li>
            """
